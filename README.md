...
****Cerințe****
    ...
    definirea a minim 3-4 clase folosind compunere cu clasele definite de voi; moștenirile nu se iau în considerare aici - PARTIAL WIP TEMA 2

    constructori de inițializare cu parametri pentru fiecare clasă - DA

    pentru o aceeași (singură) clasă: constructor de copiere, operator= de copiere, destructor - DA mai putin operator=

    operator<< pentru toate clasele pentru afișare (std::ostream) folosind compunere de apeluri cu operator<< - DA
